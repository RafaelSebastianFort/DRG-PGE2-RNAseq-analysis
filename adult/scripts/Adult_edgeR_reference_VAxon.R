...
# Reference group: VAxon

rm(list=ls())

workDir <- "results/adult_edgeR/reference_VAxon"

projectName <- "Adult_edgeR_reference_VAxon"
author <- "RAFAEL_FORT"

targetFile <- "../../../metadata/targets_adult.txt"
rawDir <- "../../../data/counts_adult"
